...
///////////////////////////////////////begin frankencode
//Notes
//Who owns the array of the enabled integrators?
...
void IntegrationMethodTwoStep::connectGSDSignal(
...
int IntegrationMethodTwoStep::slotWriteGSD( gsd_handle& handle, std::string name ) const
    {
    ...
    gwrite(handle, "state/hpmc/integrate/d", m_pdata->getNTypes(), h_d.data, GSD_TYPE_DOUBLE);
    if(m_hasOrientation)
        {
